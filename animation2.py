...
@Arankub.Arank_cmd(
    pattern="think$",
    command=("think", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="lmao$",
    command=("lmao", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}lmao",
    },
...
@Arankub.Arank_cmd(
    pattern="nothappy$",
    command=("nothappy", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}nothappy",
    },
...
@Arankub.Arank_cmd(
    pattern="clock$",
    command=("clock", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}clock",
    },
...
@Arankub.Arank_cmd(
    pattern="muah$",
    command=("muah", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}muah",
    },
...
@Arankub.Arank_cmd(
    pattern="heart$",
    command=("heart", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}heart",
    },
...
@Arankub.Arank_cmd(
    pattern="earth$",
    command=("earth", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}earth",
    },
...
@Arankub.Arank_cmd(
    pattern="moon$",
    command=("moon", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}moon",
    },
...
@Arankub.Arank_cmd(
    pattern="smoon$",
    command=("smoon", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}smoon",
    },
...
@Arankub.Arank_cmd(
    pattern="tmoon$",
    command=("tmoon", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}tmoon",
    },
