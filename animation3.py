...
@Arankub.Arank_cmd(
    pattern="star$",
    command=("star", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="boxs$",
    command=("boxs", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}boxs",
    },
...
@Arankub.Arank_cmd(
    pattern="rain$",
    command=("rain", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}rain",
    },
...
@Arankub.Arank_cmd(
    pattern="deploy$",
    command=("deploy", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}deploy",
    },
...
@Arankub.Arank_cmd(
    pattern="dump(?:\s|$)([\s\S]*)",
    command=("dump", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
...
@Arankub.Arank_cmd(
    pattern="fleaveme$",
    command=("fleaveme", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}fleaveme",
    },
...
@Arankub.Arank_cmd(
    pattern="loveu$",
    command=("loveu", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}loveu",
    },
...
@Arankub.Arank_cmd(
    pattern="plane$",
    command=("plane", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}plane",
    },
...
@Arankub.Arank_cmd(
    pattern="police$",
    command=("police", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}police",
    },
...
@Arankub.Arank_cmd(
    pattern="solarsystem$",
    command=("solarsystem", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
