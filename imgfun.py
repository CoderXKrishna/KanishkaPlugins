...
@Arankub.Arank_cmd(
    ...
    command=("imirror", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="irotate(?: |$)(\d+)$",
    command=("irotate", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    ...
    command=("iresize", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="square$",
    command=("square", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="dotify(?: |$)(\d+)?$",
    command=("dotify", plugin_Arankegory),
    info={
