...
@Arankub.Arank_cmd(
    pattern="loading$",
    command=("loading", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="asquare$",
    command=("asquare", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}asquare",
    },
...
@Arankub.Arank_cmd(
    pattern="round$",
    command=("round", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}round",
    },
...
@Arankub.Arank_cmd(
    pattern="hart$",
    command=("hart", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}hart",
    },
...
@Arankub.Arank_cmd(
    pattern="anim$",
    command=("anim", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}anim",
    },
...
async def _(event):
    ...
    animation_chars = [
        ...
        "😡",
        "😢",
        "__**[Good to see you guys....]**__(github.com/CoderXKrishna/Arankuserbot)",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
@Arankub.Arank_cmd(
    pattern="monkey$",
    command=("monkey", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}monkey",
    },
...
@Arankub.Arank_cmd(
    pattern="herber$",
    command=("herber", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}herber",
    },
...
@Arankub.Arank_cmd(
    pattern="hand$",
    command=("hand", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}hand",
    },
...
@Arankub.Arank_cmd(
    pattern="theart$",
    command=("theart", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}theart",
    },
