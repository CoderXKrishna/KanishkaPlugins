...
@Arankub.Arank_cmd(
    pattern="(\w+)say ([\s\S]*)",
    command=("cowsay", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="coin ?([\s\S]*)",
    command=("coin", plugin_Arankegory),
    info={
        "header": "Coin flipper.",
        "usage": [
            "{tr}coin <heads/tails>",
...
@Arankub.Arank_cmd(
    pattern="slap(?:\s|$)([\s\S]*)",
    command=("slap", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    ...
    command=("decide", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="shout(?:\s|$)([\s\S]*)",
    command=("shout", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="clap(?:\s|$)([\s\S]*)",
    command=("clap", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="wish(?:\s|$)([\s\S]*)",
    command=("wish", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="gbun(?:\s|$)([\s\S]*)",
    command=("gbun", plugin_Arankegory),
    info={
