...
@Arankub.Arank_cmd(
    pattern="sing$",
    command=("sing", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="gott$",
    command=("gott", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="gotm$",
    command=("gotm", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="bello$",
    command=("bello", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="logic$",
    command=("logic", plugin_Arankegory),
    info={
