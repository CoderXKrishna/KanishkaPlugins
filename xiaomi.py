...
# edited & fix by @itsz_krish_babess
...
@Arankub.Arank_cmd(
    ...
    command=("firmware", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="vendor ([\s\S]*)",
    command=("vendor", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="xspecs ([\s\S]*)",
    command=("xspecs", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    ...
    command=("fastboot", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    ...
    command=("recovery", plugin_Arankegory),
    info={
