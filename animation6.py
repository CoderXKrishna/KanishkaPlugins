...
@Arankub.Arank_cmd(
    pattern="unoob$",
    command=("unoob", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="menoob$",
    command=("menoob", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}menoob",
    },
...
@Arankub.Arank_cmd(
    pattern="upro$",
    command=("upro", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}upro",
    },
...
@Arankub.Arank_cmd(
    pattern="mepro$",
    command=("mepro", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}mepro",
    },
...
@Arankub.Arank_cmd(
    pattern="fping$",
    command=("fping", plugin_Arankegory),
...
@Arankub.Arank_cmd(
    pattern="quickheal$",
    command=("quickheal", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}quickheal",
    },
...
@Arankub.Arank_cmd(
    pattern="vquickheal$",
    command=("vquickheal", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}vquickheal",
    },
...
@Arankub.Arank_cmd(
    pattern="macoc$",
    command=("macoc", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}macoc",
    },
...
@Arankub.Arank_cmd(
    pattern="windows$",
    command=("windows", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}windows",
    },
...
@Arankub.Arank_cmd(
    pattern="linux$",
    command=("linux", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}linux",
    },
...
@Arankub.Arank_cmd(
    pattern="stock$",
    command=("stock", plugin_Arankegory),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}stock",
    },
