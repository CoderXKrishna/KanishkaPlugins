...
@Arankub.Arank_cmd(
    pattern="weeb(?:\s|$)([\s\S]*)",
    command=("weeb", plugin_Arankegory),
    info={
        "header": "chages given text into some funny way",
...
@Arankub.Arank_cmd(
    ...
    command=("downside", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    ...
    command=("subscript", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    ...
    command=("superscript", plugin_Arankegory),
    info={
