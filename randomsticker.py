...
@Arankub.Arank_cmd(
    pattern="Arank$",
    command=("Arank", plugin_Arankegory),
    info={
...
@Arankub.Arank_cmd(
    pattern="brain$",
    command=("brain", plugin_Arankegory),
    info={
...
# By:- git: Krishna tg: @Itsz_Radha_3030


@Arankub.Arank_cmd(
    pattern="pat$",
    command=("pat", plugin_Arankegory),
    info={
